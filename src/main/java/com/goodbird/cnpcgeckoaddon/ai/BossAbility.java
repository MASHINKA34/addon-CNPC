...
public enum BossAbility {
    ...
    CONE(BossAbilityKind.CONE, phase -> phase.cone().canCast(),
            phase -> phase.cone().isConfigured(),
            phase -> phase.cone().getCooldownTicks(), phase -> phase.cone().castSpot()),
    PLATFORM(BossAbilityKind.PLATFORM, phase -> phase.platform().canCast(),
            phase -> phase.platform().isConfigured(),
