...
public final class SubGuiBossRift extends SubGuiFieldScreen {
    ...
    private int layout(boolean place) {
        ...
        if (place) {
            addLabel(new GuiLabel(TITLE_LABEL, BossAnimationGuiUtil.phaseTitle("cnpcgeckoaddon.boss.rift_phase",
    ...
    private int choiceNumber(boolean place, int buttonId, int fieldId, String key, int y, String[] values,
        ...
        if (place) {
            ...
            addButton(new GuiButtonNop(this, buttonId, guiLeft + CHOICE_X, guiTop + y, CHOICE_NUMBER_WIDTH,
