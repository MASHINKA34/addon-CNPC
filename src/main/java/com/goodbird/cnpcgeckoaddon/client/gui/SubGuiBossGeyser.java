...
public final class SubGuiBossGeyser extends SubGuiFieldScreen {
    ...
    public void init() {
        super.init();
        addLabel(new ThemeLabel(30, BossAnimationGuiUtil.phaseTitle("cnpcgeckoaddon.boss.geyser_phase", phaseIndex),
                guiLeft + 8, guiTop + 5, 0xFFFFFF));
        int y = guiTop + 18;

        addLabel(new ThemeLabel(ENABLED_BUTTON, "cnpcgeckoaddon.boss.ability_enabled", guiLeft + 6, y + 6));
        addButton(new ThemeYesNo(this, ENABLED_BUTTON, guiLeft + 155, y, 87, 20, phase.geyser().isEnabled()));
        y += 21;
        ...
        addLabel(new ThemeLabel(TARGET_COUNT_FIELD, "cnpcgeckoaddon.boss.geyser_targets", guiLeft + 6, y + 6));
        ...
        addLabel(new ThemeLabel(FOLLOW_BUTTON, "cnpcgeckoaddon.boss.geyser_follow", guiLeft + 6, y + 6));
        ...
        addButton(new ThemeButton(this, SKY_BUTTON, guiLeft + 6, y, 236, 20, "cnpcgeckoaddon.boss.geyser_sky"));
        y += 21;
        addButton(new ThemeButton(this, RESIDUE_BUTTON, guiLeft + 6, y, 236, 20,
                "cnpcgeckoaddon.boss.geyser_residue"));

        addLabel(new ThemeLabel(31, "cnpcgeckoaddon.boss.geyser_hint", guiLeft + 6, guiTop + 334, 0xA0A0A0));
        addButton(new ThemeButton(this, TUNING_BUTTON, guiLeft + 6, guiTop + 344, 236, 20,
                "cnpcgeckoaddon.boss.geyser_tuning"));
        addButton(new ThemeButton(this, EFFECTS_BUTTON, guiLeft + 6, guiTop + 368, 120, 20,
