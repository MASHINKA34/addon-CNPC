...
public final class SubGuiNpcImmunity extends SubGuiFieldScreen {
     ...
     * eight rows each since the marks made it fifteen.
     */
    ...
    public void init() {
        ...
        int y = addWrappedHint(FIRST_HINT_LABEL, "cnpcgeckoaddon.npc.immunity_hint", guiTop + 204);
        addWrappedHint(FIRST_HINT_LABEL + 10, "cnpcgeckoaddon.npc.immunity_blast_hint", y + 4);
        addButton(new GuiButtonNop(this, RESIST_BUTTON, guiLeft + 8, guiTop + 254, 140, 20,
                "cnpcgeckoaddon.npc.resist_open",
                button -> setSubGui(new SubGuiNpcDamageResistList(data))));
        addButton(new GuiButtonNop(this, 66, guiLeft + 182, guiTop + 254, 60, 20,
