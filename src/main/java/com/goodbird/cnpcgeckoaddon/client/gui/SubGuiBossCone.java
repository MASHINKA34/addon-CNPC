...
public final class SubGuiBossCone extends SubGuiFieldScreen {
    ...
    private int layout(boolean place) {
        ...
        if (place) {
            addLabel(new GuiLabel(TITLE_LABEL, BossAnimationGuiUtil.phaseTitle("cnpcgeckoaddon.boss.cone_phase",
        ...
        if (cone.getAimMode() == BossPhaseData.CONE_AIM_POINTS) {
            ...
            if (place) {
                addButton(new GuiButtonNop(this, POINTS_BUTTON, guiLeft + LABEL_X, guiTop + y,
