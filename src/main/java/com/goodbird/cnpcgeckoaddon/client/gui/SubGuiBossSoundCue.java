...
public final class SubGuiBossSoundCue extends SubGuiFieldScreen {
    ...
    public void init() {
        ...
        super.init();
        addLabel(new GuiLabel(TITLE_LABEL, Component.translatable("cnpcgeckoaddon.cue.sound_title")
        ...
        addLabel(new GuiLabel(SOUND_FIELD, "cnpcgeckoaddon.cue.sound_id", guiLeft + 8, y + 6));
        addTextField(new GuiTextFieldNop(SOUND_FIELD, this, guiLeft + TEXT_FIELD_X, y, 86,
                BUTTON_HEIGHT, cue.getSoundId()));
        addButton(new GuiButtonNop(this, SOUND_FIELD, guiLeft + 198, y, 44, BUTTON_HEIGHT,
