...
public final class SubGuiBossCastMovement extends GuiBasic {
    ...
    /**
     * Two columns, the way the warning and immunity screens list the same abilities. Nine
     * rows since the hunt: sixteen choices and the leap's placeholder no longer fit in eight.
     */
    ...
    public void init() {
        ...
        int y = addWrappedHint(FIRST_HINT_LABEL,
                "+ " + I18n.get("cnpcgeckoaddon.boss.cast_move_rooted")
                        + "   - " + I18n.get("cnpcgeckoaddon.boss.cast_move_free"), guiTop + 226);
        ...
        addButton(new GuiButtonNop(this, 66, guiLeft + 182, guiTop + 278, 60, 20,
