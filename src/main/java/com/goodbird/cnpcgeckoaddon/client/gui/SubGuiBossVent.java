...
public final class SubGuiBossVent extends SubGuiFieldScreen {
    ...
    private int layout(boolean place) {
        ...
        if (place) {
            addLabel(new ThemeLabel(TITLE_LABEL, BossAnimationGuiUtil.phaseTitle("cnpcgeckoaddon.boss.vent_phase",
    ...
    private int choiceAndNumber(boolean place, int buttonId, int fieldId, String key, int y, String[] values,
        ...
        if (place) {
            ...
            addButton(new ThemeButton(this, buttonId, guiLeft + CHOICE_X, guiTop + y, CHOICE_BESIDE_WIDTH,
